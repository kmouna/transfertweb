                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::open(['action' => ['chauffeurController@update',$unChauffeur->id],
                            'method' => 'PUT', 'enctype'=>'multipart/form-data']) !!}
                            <div class="form-group">
                                {!! Form::label('nom', 'Nom') !!}
                                {!! Form::text('nom',$unChauffeur->nom, ['class' => 'form-control', 'placeholder' =>
                                'Nom Chauffeur','required' => 'required']) !!}
                            </div>
                            <div class="form-group">
                                {!! Form::label('prenom', 'Prénom') !!}
                                {!! Form::text('prenom',$unChauffeur->prenom, ['class' => 'form-control', 'placeholder'
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::date('datenais',$unChauffeur->datenais, ['class' =>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::text('mobile',$unChauffeur->mobile, ['class' => 'form-control','pattern'
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::email('email',$unChauffeur->email, ['class' => 'form-control','pattern' =>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-addon">
                                        <img src="{{asset('storage/chauffeurs')}}/{{$unChauffeur->photo}}"
                                            id="previewImg" class="direct-chat-img" alt="Aperçu chauffeur photo" />
                                        {{ Form::hidden('cachenomphoto',$unChauffeur->photo,
                                        ['class' => 'form-control'])}}
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::textarea('adresse',$unChauffeur->adresse, ['class' => 'form-control
                                textarea']) !!}
                            </div>
                            <div class="form-group">
