...
<?php $__env->startSection('body'); ?>
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo e($dashboard_url); ?>"><?php echo '<b>Trans</b>Fert'; ?></a>
        </div>
        <div class="card">
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\transfert\vendor\jeroennoten\laravel-adminlte\src/../resources/views/login.blade.php ENDPATH**/ ?>